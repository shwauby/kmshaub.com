        ...
        <div class="vpf-welcome-screen">
            <div class="vpf-welcome-head">
                ...
                <div class="vpf-welcome-head-pro-info">
                    ...
                    <div>
                        ...
                        echo sprintf( esc_html__( 'Want to get more power with Pro? Visit %s', 'visual-portfolio' ), '<a target="_blank" rel="noopener noreferrer" href="https://visualportfolio.co/pro/?utm_source=plugin_welcome&utm_medium=link&utm_campaign=pro&utm_content=2.12.1">visualportfolio.co/pro</a>' );
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="vpf-welcome-content">
                ...
                <div class="vpf-welcome-content-buttons">
                    <a target="_blank" rel="noopener noreferrer" href="https://visualportfolio.co/?utm_source=plugin_welcome&utm_medium=link&utm_campaign=demo&utm_content=2.12.1"><?php echo esc_html__( 'More Features', 'visual-portfolio' ); ?></a>
                    <a target="_blank" rel="noopener noreferrer" href="https://visualportfolio.co/documentation/getting-started/?utm_source=plugin_welcome&utm_medium=link&utm_campaign=docs&utm_content=2.12.1"><?php echo esc_html__( 'Documentation', 'visual-portfolio' ); ?></a>
                </div>
            </div>
            ...
            <div class="vpf-welcome-foot-pro-info">
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://visualportfolio.co/pro/?utm_source=plugin_welcome&utm_medium=link&utm_campaign=pro&utm_content=2.12.1"><?php echo esc_html__( 'Upgrade to PRO Now', 'visual-portfolio' ); ?></a>
            </div>
        </div>
        <?php
    }
