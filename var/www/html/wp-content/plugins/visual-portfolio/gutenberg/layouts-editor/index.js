            ...
            <Fragment>
                <InspectorControls>
                    ...
                    >
                        ...
                        <p>
                            { __( 'Filter (optional):', 'visual-portfolio' ) }
                            <br />
                            <code
                                role="button"
                                tabIndex="0"
                        ...
                        <p>
                            { __( 'Sort (optional):', 'visual-portfolio' ) }
                            <br />
                            <code
                                role="button"
                                tabIndex="0"
...
registerBlockType( 'visual-portfolio/saved-editor', {
    ...
    description: sprintf( __( 'Edit saved %s layouts.', 'visual-portfolio' ), pluginName ),
    icon: {
        foreground: '#2540CC',
        src: (
